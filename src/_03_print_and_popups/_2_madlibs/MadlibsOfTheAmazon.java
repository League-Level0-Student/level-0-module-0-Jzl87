...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog("Enter an Adjective Below!");
		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("Enter Liquid Below!");
		// Get the player to enter a body part
		String part = JOptionPane.showInputDialog("Enter body part Below!");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("Enter verb Below!");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("Enter place Below!");
